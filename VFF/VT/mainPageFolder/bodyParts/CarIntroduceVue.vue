...
export default {
    ...
    setup(props, context) {
        ...
        const params = ref({
            curretSlideNumber: 2,
            slideNumberVideo: [
                '<iframe width="600px" height="100%" src="https://www.youtube.com/embed/1rHbJ-TG5TI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                '<iframe width="600px" height="100%" src="https://www.youtube.com/embed/Dr0Qlftwa4c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                '<iframe width="600px" height="100%" src="https://www.youtube.com/embed/sZv0MLe1wp0?start=40" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                '<iframe width="600px" height="100%" src="https://www.youtube.com/embed/3uhMmaYfhAI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
            ],
            changePlayer: false,
            settingNumber: 0,
            selectVisible: true,
